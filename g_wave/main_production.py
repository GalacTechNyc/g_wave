...
grok = ChatOpenAI(model="grok-4-0709", base_url="https://api.x.ai/v1", api_key=os.getenv("XAI_API_KEY"))
...
"""
            ...
            self_improvement_task = (
                ...
                f"Then, create a plan to modify the code and fix the bug. You must use the 'replace_in_file' tool."
            )
            ...
            cmd = [sys.executable, "-m", "g_wave.main", original_task]
